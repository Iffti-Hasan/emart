...
The system uses PHP for backend validation and database interaction with MySQL.As a beginner-level project, it currently has multiple vulnerabilities and limited security, but I plan to make it smarter and more secure in future updates.*
  ...
  ***<h3>🟦 Client (Customer) Features:</h3>***
    ...
    ◼️ User Registration & Login: Secure authentication system that allows customers to create accounts and log in using valid credentials.
    ◼️ Product Browsing: View all available products displayed in a clean, responsive grid or card layout for easy navigation.
    ...
    ◼️ Feedback: Submit reviews and feedback for purchased products or general shopping experience.
    ◼️ Logout: Securely end the customer session.
